...
class Cliente(db.Model):
    ...
    comuna_id = db.Column(db.Integer,  db.ForeignKey('Comuna.id_comuna') , nullable= True)
...
class Comuna(db.Model):
    ...
    Region_id_region = db.Column(db.Integer,  db.ForeignKey('Region.id_region') ,nullable= True)
...
class Detalle(db.Model):
    ...
    estado = db.Column(db.String(1), nullable= False)
    venta_id = db.Column(db.Integer,  db.ForeignKey('Venta.id_venta') ,nullable= True)
    producto_id = db.Column(db.Integer,  db.ForeignKey('Producto.id_producto') , nullable= True)
...
class Donacion(db.Model):
    ...
    valor = db.Column(db.Integer, nullable= False)
    fecha = db.Column(db.Date, nullable= False)
    cliente_id = db.Column(db.Integer,  db.ForeignKey('Cliente.id_usuario') , nullable= True)
